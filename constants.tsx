...
const BRADFORD_LOCATIONS_DATA: Omit<ExtendedAreaData, 'localFAQs'>[] = [
  ...
  { 
    ...
    nearbyIds: ['city-centre', 'heaton', 'girlington', 'frizinghall', 'allerton'],
  ...
  { 
    ...
    nearbyIds: ['city-centre', 'undercliffe', 'bowling', 'eccleshill'],
...
const LEEDS_LOCATIONS_DATA: Omit<ExtendedAreaData, 'localFAQs'>[] = [
  ...
  { 
    ...
    nearbyIds: ['chapel-allerton', 'harehills', 'oakwood'], communityContext: 'An affluent area with wide residential avenues and a massive public park.', 
  ...
  { 
    ...
    nearbyIds: ['roundhay', 'gipton', 'burmantofts'], communityContext: 'A densely populated urban area with high traffic volume and complex junctions.', 
  ...
  { 
    ...
    nearbyIds: ['middleton', 'stourton', 'beeston'], communityContext: 'An industrial and residential mix with many large roundabouts and dual carriageways.', 
  ...
  { 
    ...
    nearbyIds: ['hunslet', 'holbeck', 'cottingley'], communityContext: 'Home to Leeds United and the White Rose Shopping Centre, seeing heavy match-day traffic.', 
  ...
  { 
    ...
    nearbyIds: ['wortley', 'bramley', 'farnley'], communityContext: 'A historic industrial suburb with steep hills and busy commuter routes.', 
  ...
  { 
    ...
    nearbyIds: ['armley', 'rodley', 'pudsey'], communityContext: 'A large residential area with a mix of council estates and private housing.', 
  ...
  { 
    ...
    nearbyIds: ['whinmoor', 'thorner', 'cross-gates'], communityContext: 'One of the largest council estates in Europe, featuring wide roads and large roundabouts.', 
  ...
  { 
    ...
    nearbyIds: ['halton', 'whitkirk', 'seacroft'], communityContext: 'A popular residential suburb with a busy shopping centre and railway station.', 
  ...
  { 
    ...
    nearbyIds: ['cookridge', 'bramhope', 'headingley'], communityContext: 'An affluent residential area on the northern edge of the city.', 
  ...
  { 
    ...
    nearbyIds: ['moortown', 'shadwell', 'harewood'], communityContext: 'A prestigious residential area with wide avenues and close proximity to the countryside.', 
  ...
  { 
    ...
    nearbyIds: ['adel', 'cookridge', 'rawdon'], 
  ...
  { 
    ...
    nearbyIds: ['rawdon', 'guiseley', 'horsforth'], communityContext: 'Home to the regional airport, seeing high volumes of taxi and airport traffic.', 
  ...
  { 
    ...
    nearbyIds: ['yeadon', 'menston', 'otley'], 
  ...
  { 
    ...
    nearbyIds: ['guiseley', 'pool', 'menston'], communityContext: 'A traditional market town with narrow streets and rural surroundings.', 
  ...
  { 
    ...
    nearbyIds: ['collingham', 'boston-spa', 'linton'], communityContext: 'A historic market town situated on the River Wharfe near the A1(M).', 
  ...
  { 
    ...
    nearbyIds: ['wetherby', 'bramham', 'clifford'], communityContext: 'A picturesque village with a busy High Street and rural access.', 
  ...
  { 
    ...
    nearbyIds: ['boston-spa', 'sherburn', 'garforth'], communityContext: 'A brewing town famous for its bridge and proximity to the A64.', 
  ...
  { 
    ...
    nearbyIds: ['kippax', 'micklefield', 'cross-gates'], communityContext: 'A large commuter town with excellent rail and road links to Leeds.', 
  ...
  { 
    ...
    nearbyIds: ['woodlesford', 'oulton', 'methley'], communityContext: 'A historic town with a mix of old residential areas and modern estates.', 
  ...
  { 
    ...
    nearbyIds: ['churwell', 'gildersome', 'beeston'], communityContext: 'A large town with a strong local identity and busy commercial centre.', 
  ...
  { 
    id: 'pudsey-leeds', city: 'leeds', name: 'Pudsey', postcode: 'LS28', 
    ...
    nearbyIds: ['farsley', 'stanningley', 'bramley'], communityContext: 'A historic market town between Leeds and Bradford with varied road types.', 
  ...
  { 
    ...
    nearbyIds: ['burley-in-wharfedale', 'menston', 'addingham'], communityContext: 'A famous spa town on the edge of the Yorkshire Dales.', 
    ...
    prepParagraphs: [
      ...
      'Our DVSA preparation includes [Mock Driving Tests](/mock-driving-tests) that focus on the busy A65 tourist flow and the junctions near the Cow and Calf Rocks. We ensure you can master these tricky local layouts and pass your test in this famous spa town.'
    ]
  },
];
