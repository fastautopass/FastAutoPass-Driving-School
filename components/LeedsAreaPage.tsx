...
interface LeedsAreaPageProps {
  area: AreaData & { city: string };
}

const LeedsAreaPage: React.FC<LeedsAreaPageProps> = ({ area }) => {
  React.useEffect(() => {
    document.title = `Automatic Driving Lessons in ${area.name} | Leeds ${area.postcode}`;
    ...
    metaDescription.setAttribute('content', `Learn to drive in ${area.name} with local Leeds automatic specialists. patient instruction, expert test route practice, and modern dual-controlled cars.`);
  }, [area]);
  ...
  return (
    <div className="animate-fadeIn font-inter text-gray-800 bg-white location-page">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-7/12">
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl font-medium italic">
                Pass your driving test with confidence in {area.name} using our modern automatic dual-controlled cars. Expert local tuition for the {area.city === 'leeds' ? 'Leeds' : 'Bradford'} area.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white p-10 lg:p-16 rounded-[3rem] shadow-xl border border-gray-100 h-fit">
              {(() => {
                ...
                const version = (index + 2) % 4; // Offset to diversify from Bradford pages
      ...
      {/* 9. Mock Test & Test Preparation in Leeds Location */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-5xl font-black mb-4 italic uppercase tracking-tighter text-gray-900">Local Map of {area.name}, Leeds</h2>
            ...
            <div className="relative group bg-white p-4 rounded-[3rem] shadow-2xl border border-gray-100 overflow-hidden aspect-video">
              <iframe 
                title={`Map of ${area.name} Leeds for automatic driving lessons`}
                src={mapUrl}
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
