...
interface BradfordAreaPageProps {
...
const BradfordAreaPage: React.FC<BradfordAreaPageProps> = ({ area }) => {
  ...
  const mapQuery = encodeURIComponent(`${area.name}, Bradford, UK`);
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-lg text-gray-600 font-medium leading-relaxed space-y-6">
            {area.introParagraphs && area.introParagraphs.length > 0 ? (
              ...
              <>
                <p>
                  Looking for professional <span className="text-red-600 font-bold italic underline">automatic driving lessons in {area.name}</span>? At FastAutoPass, we provide high-quality, patient instruction tailored specifically to the unique road conditions of {area.name} and the wider Bradford region.
                </p>
                <p>
                  Whether you are a complete beginner or looking to switch from manual, our local instructors know the area intimately. We focus on building your confidence, removing the stress of gear changes, and ensuring you are fully prepared for the challenges of modern Bradford traffic.
                </p>
              </>
            )}
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-10 bg-gray-50 rounded-[2rem] border border-gray-100">
              ...
              <p className="text-gray-600">Popular pick-up points include {area.colleges.join(', ') || 'Local stations and hubs'}.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-5xl font-black mb-4 italic uppercase tracking-tighter text-gray-900">Local Map of {area.name}, Bradford</h2>
...
export default BradfordAreaPage;
