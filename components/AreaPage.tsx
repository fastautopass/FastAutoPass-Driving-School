...
const MarkdownLink: React.FC<any> = ({ href, children, ...props }) => {
  ...
  const classes = href?.includes('/intensive-driving-courses') || href?.includes('/mock-driving-tests')
    ? "text-red-600 font-bold hover:underline transition-colors"
    : "text-red-600 font-bold hover:underline transition-colors";
    ...
    <div className="animate-fadeIn font-inter text-gray-800 bg-white area-page">
      ...
      <section className="py-12 bg-white border-b border-gray-100">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="prose prose-lg text-gray-600 font-medium leading-relaxed space-y-6 max-w-none">
      ...
      {/* 3. RECENT PASSES SLIDESHOW */}
      <RecentPasses areaName={area.name} />

      {/* 4. LOCAL ENVIRONMENT & COMMUNITY */}
      ...
      {/* 4. LOCAL ROAD & JUNCTION ANALYSIS */}
      <section className="py-12 bg-white border-b border-gray-100">
      ...
      {/* 6. LOCAL AREA MAP SECTION (MANDATORY PLACEMENT) */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-400 font-medium leading-relaxed max-w-none">
      ...
      {/* SEO AUTHORITY & SOFT CTA SECTION */}
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
              ...
              <ReadMore buttonText={`Read more about lessons in ${area.name}`}>
            ...
            <div className="bg-white p-8 lg:p-12 rounded-[3rem] shadow-2xl border border-gray-100 flex flex-col justify-center text-center h-full">
              <div className="mb-8">
                <h3 className="text-2xl lg:text-3xl font-black mb-4 italic uppercase tracking-tighter text-gray-900 leading-tight">
                  Start Automatic Driving Lessons in {area.name}
                </h3>
                <p className="text-gray-500 font-medium italic leading-relaxed">
                  Speak with a local instructor about lesson options, course availability, and getting started in {area.name}.
                </p>
              </div>
              
              <a 
                href="#booking" 
                className="bg-red-600 text-white px-10 py-5 rounded-2xl font-black text-xl hover:bg-red-700 transition-all shadow-xl hover:shadow-red-200 uppercase italic tracking-widest text-center"
              >
                Enquire
              </a>
              
              <div className="mt-8 flex items-center justify-center space-x-2 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                <span>Local {area.name} instructors available</span>
              </div>
            </div>
          </div>
        </div>
