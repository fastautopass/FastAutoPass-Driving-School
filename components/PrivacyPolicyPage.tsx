...
const PrivacyPolicyPage: React.FC = () => {
  useEffect(() => {
    document.title = "Privacy Policy | FastAutoPass Driving School";
    ...
    metaDescription.setAttribute('content', "Learn how FastAutoPass Driving School protects your personal data. Our privacy policy outlines our commitment to UK GDPR and data security for all our learners in Bradford and Leeds.");
    window.scrollTo(0, 0);
  }, []);
