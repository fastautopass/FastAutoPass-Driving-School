...
const AdiPart3Page: React.FC = () => {
  ...
  useEffect(() => {
    document.title = "ADI Part 3 Training Bradford & Leeds | Instructional Ability | FastAutoPass";
    ...
    metaDescription.setAttribute('content', 'Master the ADI Part 3 test with expert instructional coaching in Bradford and Leeds. Professional training for aspiring driving instructors in West Yorkshire.');
  }, []);
